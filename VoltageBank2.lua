...
local VoltageBank2 = Class{}
VoltageBank2:include(Unit)

function VoltageBank2:init(args)
  args.title = "Voltage Bank"
  args.mnemonic = "VB"
  Unit.init(self,args)
end

function VoltageBank2:onLoadGraph(channelCount)
  -- create objects
...
function VoltageBank2:serialize()
  local t = Unit.serialize(self)
  t.voltageBankOp = self.op
  return t
end

function VoltageBank2:deserialize(t)
...
local indexMap = intMap(1,2)  -- adjust max param for numSlots
...
function VoltageBank2:onLoadViews(objects,branches)
  local controls = {}
